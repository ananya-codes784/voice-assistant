...
function wishMe() {
  ...
  if (hours >= 0 && hours < 12) {
    speak("Good Morning Annie");
  } else if (hours >= 12 && hours < 16) {
    speak("Good Afternoon Annie");
  } else {
    speak("Good Evening Annie");
  }
}
...
function takeCommand(message) {
  ...
  if (message.includes("hello") || message.includes("hey")) {
    speak("hello annie ,what can i help you?");
  } else if (message.includes("who are you")) {
    speak("i am coco a virtual assistant, created by annie");
  } else if (message.includes("how are you")) {
    speak("i am great , what about you?");
  } else if (message.includes("say something")) {
    speak("nothing just waiting for you ");
